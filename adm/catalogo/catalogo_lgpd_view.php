...
if (isset($_SESSION['global_id_usuario']) && !empty($_SESSION['global_id_usuario']) && isset($acao) && $acao != null) {
    ...
    if ($acesso == "TELA AUTORIZADA") {
        ...
        // Verifica se o parâmetro "user=ON" foi enviado
        ...
        if ($filtrarUsuario) {
            $query_ambiente = "
                ...
                ORDER BY c.ambiente
            ";
            $result_ambiente = pg_query_params($conexao, $query_ambiente, [$_SESSION['global_id_usuario']]);
        } else {
...
<body>
    ...
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form id="filterForm" method="GET" class="row g-3">
                ...
                <!-- Repasse do parâmetro user se estiver definido -->
    ...
    <script>
        // Lê o parâmetro "user" da URL e o repassa para as chamadas AJAX
