...
$titulo="Cadastro Regra de Menu";
$titulo_listar="Regras Já Cadastradas";
$id_item=$_GET['id_item'];
$arquivo="cad_menu_regra.php";
$tabela="sgc_regra_menu";
...
<form method="POST" id="form1" action="sgc.php?action=cad_menu_regra.php&acao_int=select_menu" style="font-family: Verdana; font-size: 8pt">
...
<script language="javascript"  src="ajax-usuario-menu.js" type="text/javascript"></script>
...
<form method="POST" id="form1" name='meuFormulario' action="sgc.php?action=cad_menu_regra.php&acao_int=cad_bd_regra" onsubmit='seleciona();loopSelectedAS()' style="font-family: Verdana; font-size: 8pt">
...
<div align="center">
	<table class="border" cellSpacing="0" cellPadding="0" width="100%" border="0">
		<tr style="color: #000000; font-family: Arial, Helvetica, sans-serif; font-size: 12px">
			...
			<table cellSpacing="1" cellPadding="5" width="100%" border="0">
				<tr style="color: #000000; font-family: Arial, Helvetica, sans-serif; font-size: 12px">
					<td class="info" align="middle"><b>:: Adicionar Item ao Menu <?echo $titulo?> :: </b></td>
				</tr>
				<tr style="color: #000000; font-family: Arial, Helvetica, sans-serif; font-size: 12px">
					<td class="cat" align="center">
					<table border="0" width="488" cellspacing="0" cellpadding="0">
...
$deleta = mysql_query("DELETE FROM sgc_regra_menu where id_usuario=$usuario and id_menu=$menu ") or print(mysql_error());

foreach($vetor_conjunto as $value){
 echo "Item:$value <br>";

  $checa = mysql_query("select * from sgc_regra_menu where id_menu=$menu and id_item_menu=$value and id_usuario=$usuario") or $myerr = mysql_error();
  $row = mysql_num_rows($checa);

  if($row<1){
     $cadas = mysql_query("INSERT INTO sgc_regra_menu (id_menu, id_item_menu, id_usuario, data_criacao,quem_criou)
                         VALUES ($menu,$value,$usuario,sysdate(),$idusuario)") or print(mysql_error());
  }
 }
$cadas = mysql_query("UPDATE sgc_usuario SET perfil='CUSTOMIZADO',data_alteracao=sysdate(),quem_alterou=$idusuario, oque_alterou='PERFIL' where id_usuario=$usuario") or print(mysql_error());

header("Location: ?action=cad_menu_regra.php&acao_int=select_menu&id_item=$id_item&id_usuario=$usuario");
}
