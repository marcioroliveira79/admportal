...
$titulo_listar="Tipos de Gasto já cadastrados";
...
function valida_dados (nomeform)
{
    ...
    {
        alert ("\nDigite o código para Tipo de Gasto.");
				...
				<tr style="color: #000000; font-family: Arial, Helvetica, sans-serif; font-size: 12px">
					...
					<table border="0" width="488" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<p align="center">Descrição da Tipo de Gasto(AJUDA)</td>
						</tr>
						<tr>
...
function valida_dados (nomeform)
{
    ...
    if (nomeform.codigo.value=="")
    {
        alert ("\nDigite o código para o Tipo de Gasto.");
			...
			<table cellSpacing="1" cellPadding="5" width="100%" border="0">
				...
				<tr style="color: #000000; font-family: Arial, Helvetica, sans-serif; font-size: 12px">
					...
					<table border="0" width="488" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td width="488" colspan="2" height="23">
							<p align="center">Descrição do Campo Tipo de Gasto
							(AJUDA)</td>
						</tr>
						<tr>
							<td height="23" width="70">
 ...
 echo $permissao_item=acesso($idusuario,$id_item);
  ...
  if($permissao_item=="OK"){
    ...
    if($integridade_codigo=="Existe"){
      ...
      header("Location: ?action=cad_tipo_gasto.php&id_item=$id_item&msg=Este código já esta sendo usado");
      exit;
    }else{
    if($integridade=="Existe"){

      header("Location: ?action=cad_tipo_gasto.php&id_item=$id_item&msg=Já existe uma área com este nome");
