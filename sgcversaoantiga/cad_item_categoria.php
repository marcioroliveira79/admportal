...
$titulo="Cadastro Item de Categoria";
$titulo_listar="Itens Já Cadastrados";
$id_item=$_GET['id_item'];
$arquivo="cad_item_categoria.php";
$tabela="sgc_item_categoria";
$id_chave="id_item";
			...
			<table cellSpacing="1" cellPadding="5" width="100%" border="0">
				...
				<tr style="color: #000000; font-family: Arial, Helvetica, sans-serif; font-size: 12px">
					...
					<table border="0" width="533" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td width="120">
							<p align="right">Item Categoria:&nbsp; </td>
						...
						<tr>
							<td width="533" colspan="2" height="23">
							<p align="center">Descrição do Item de Categoria(AJUDA)</td>
						</tr>
						<tr>
							<td height="23" width="70">
							<p align="right">&nbsp; </td>
							<td height="23" width="423">
			...
			<table cellSpacing="1" cellPadding="5" width="100%" border="0">
				...
				<tr style="color: #000000; font-family: Arial, Helvetica, sans-serif; font-size: 12px">
					...
					<table border="0" width="488" cellspacing="0" cellpadding="0">
                        ...
                        <?
                          $checa = mysql_query("select * from sgc_item_categoria order by descricao desc ") or print(mysql_error());
