...
$checa = mysql_query("
SELECT if(status='LIMBO','Aguardando Parametrização',status) status ,count(status)total FROM sgc_chamado ch
where 1=1
group by status
...
<script type="text/javascript">
	...
	myChart.setTitle('Status dos Chamados em <?echo data_with_hour(datahoje('datahora')); ?>');
