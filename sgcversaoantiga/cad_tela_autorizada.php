...
$titulo="Autorização de Tela";
$titulo_listar="Telas Já Cadastrados";
$id_item=$_GET['id_item'];
$arquivo="cad_tela_autorizada.php";
$tabela="sgc_tela";
$id_chave="id_tela";
...
function valida_dados (nomeform)
{
    ...
    {
        alert ("\nDigite a descricao para a Tela.");
				...
				<tr style="color: #000000; font-family: Arial, Helvetica, sans-serif; font-size: 12px">
					...
					<table border="0" width="576" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<p align="center">Descrição do Tela(AJUDA)</td>
						</tr>
						<tr>
...
elseif($acao_int=="editar_bd"){
   ...
   if($permissao_item=="OK"){
    ...
    if($existe=="Existe"){
     $msg="Já existe uma tela com este titulo";
				...
				<tr style="color: #000000; font-family: Arial, Helvetica, sans-serif; font-size: 12px">
					...
					<table border="0" width="488" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<p align="center">Descrição da Tela(AJUDA)</td>
						</tr>
						<tr>
							<td height="23" width="70">
							<p align="right">&nbsp; </td>
						...
						<tr>
							<td colspan="2">
							<input type="submit" value="Editar Tela" name="submit" style="font-family: Verdana, arial, helvetica, sans-serif; font-size: 11px; color: #000000; float: right; background: #C0C0C0"></td>
						</tr>
					</table>
					</td>
				</tr>
 ...
 echo $permissao_item=acesso($idusuario,$id_item);
  ...
  if($permissao_item=="OK"){
    ...
    if($integridade=="Existe"){
      ...
      header("Location: ?action=$arquivo&id_item=$id_item&msg=Já existe uma tela com este nome");
